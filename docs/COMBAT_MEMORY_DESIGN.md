...
> 2026-09-11 确认的身份公开规则覆盖本文旧候选示例：只有司令撞雷并亮旗，才自动公开存活敌方地雷身份；之后吃掉该已公开地雷，向四方确认攻击者是工兵。仅吃掉某位玩家私下已知的地雷，不触发这条公开确认。工兵专属合法路径仍可独立公开工兵身份。存档必须保存 CombatMemory；公开地雷与工兵不能继承不相容的普通军阶下界。实现依据为 RULES §3.4 与 INFERENCE R5/R7。

...
enum ShowMode {
    SHOW_MODE_BRIGHT = 0, // 明棋/开棋 (所有可见)
    SHOW_MODE_DARK = 1,   // 暗棋 (隐藏非己方)
    SHOW_MODE_HALF_DARK = 2 // 半暗棋 (隐藏左右两家)
};
...
{
	u8 bReplay;
	/* Application-level audio mute.  This is independent of macOS volume. */
	u8 bMute;
	u8 bSelect;
	u8 bStart;
	u8 bStop;
